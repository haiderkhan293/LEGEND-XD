...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY OZEBA-XD 💙*",
// set the auto reply massage on status reply  
MENTION_REPLY: process.env.MENTION_REPLY || "false",
// make true if want auto voice reply if someone menetion you 
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
STICKER_NAME: process.env.STICKER_NAME || "OZEBA XD\ndo .allvar to change sticker pack name",
// type sticker pack name 
CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
// make this true for custum emoji react    
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙, ,🤎,🚹,🤍",
// chose custom react emojis by yourself 
OWNER_NUMBER: process.env.OWNER_NUMBER || "2349126793637",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "GOODNESS TECH",
// add bot owner name
...
DEV: process.env.DEV || "2349126793637",
